...
✅ [Pyth Hermes] Получена цена BTC/USD: $60000.0000
✅ [Pyth Hermes] Получена цена ETH/USD: $2500.0000
✅ [Pyth Hermes] Получена цена SOL/USD: $150.0000
--- Часть B: Вычисление цены токена BVC в USDC ---
Получение данных из пула BVC/WSOL...
Цена из пула: 1 BVC = 0.000001 WSOL
Цена из оракула: 1 WSOL ≈ 150.0000 USDC
----------------------------------------------------
 Рассчитанная цена: 1 BVC = 0.000150 USDC (≈ $0.000150)
----------------------------------------------------
--- Часть C: Прогнозирование цен в BTC и ETH ---
Прогнозируемая цена: 1 BVC ≈ 2.5000e-9 BTC
Прогнозируемая цена: 1 BVC ≈ 6.0000e-8 ETH
```
